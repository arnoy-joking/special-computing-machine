    ...
    <footer id="player-bar" className="fixed bottom-0 left-0 w-full bg-[#121212]/80 backdrop-blur-lg border-t border-[#333] z-40 h-16 sm:h-20">
      ...
      <div className="flex items-center justify-between h-full px-2 sm:px-4">
        ...
        <div className="flex items-center justify-end space-x-2 sm:space-x-4 flex-1 sm:flex-none">
            ...
            <Button variant="ghost" onClick={() => setVideoPlayerOpen(!isVideoPlayerOpen)} className={cn("text-gray-400 hover:text-primary transition", isVideoPlayerOpen && "text-primary border-primary")} title="Toggle Video" disabled={!currentTrack}>
